...
public interface MissionCompleteRepository extends JpaRepository<MissionComplete, Long> {
    ...
    @Query(value = "select mission_id from mission_complete where member_id1 = :memberId1 and member_id2 = :memberId2 and complete1 = true and complete2 = true", nativeQuery = true)
